...
import com.rdmn.plutus.helperapp.Messages.Errors;
...
public class HelperHome extends AppCompatActivity
    ...
    private DatabaseReference helpers, onlineRef, currentUserRef;
    ...
    public void initDrawer(){
        ...
        TextView tvName=(TextView)navigationHeaderView.findViewById(R.id.tvHelperName);
        ...
        FirebaseDatabase.getInstance().getReference(Common.user_helper_tbl)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        currentUserRef=FirebaseDatabase.getInstance().getReference(Common.helper_tbl).child(Common.currentUser.getHelpType())
                                .child(Common.userID);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_usage:
                showUsage();
                break;
            case R.id.nav_help_type:
                showDialogUpdateHelpType();
                break;
    ...
    private void showUsage() {
        Intent intent=new Intent(HelperHome.this, AppInfos.class);
        startActivity(intent);
    }

    private void showHelpHistory() {
        Intent intent=new Intent(HelperHome.this, HelpHistory.class);
        startActivity(intent);
    }

    private void showDialogUpdateHelpType() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(HelperHome.this);
        alertDialog.setTitle("UPDATE HELP TYPE");
        LayoutInflater inflater = this.getLayoutInflater();
        View helpType = inflater.inflate(R.layout.layout_update_help_type, null);
        final RadioButton rbHelp1=helpType.findViewById(R.id.rbHelp1);
        final RadioButton rbHelp2=helpType.findViewById(R.id.rbHelp2);

        if(Common.currentUser.getHelpType().equals("Help1"))
            rbHelp1.setChecked(true);
        else if(Common.currentUser.getHelpType().equals("Help2"))
            rbHelp2.setChecked(true);

        alertDialog.setView(helpType);
        alertDialog.setPositiveButton("UPDATE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                final android.app.AlertDialog waitingDialog = new SpotsDialog.Builder().setContext(HelperHome.this).build();
                waitingDialog.show();
                Map<String, Object> updateInfo=new HashMap<>();
                if(rbHelp1.isChecked())
                    updateInfo.put("helpType", rbHelp1.getText().toString());
                else if(rbHelp2.isChecked())
                    updateInfo.put("helpType", rbHelp2.getText().toString());

                DatabaseReference helperInformation = FirebaseDatabase.getInstance().getReference(Common.user_helper_tbl);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if(task.isSuccessful())
                                    Toast.makeText(HelperHome.this,"Information Updated!",Toast.LENGTH_SHORT).show();
                                else
                                    Toast.makeText(HelperHome.this,"Information Update Failed!",Toast.LENGTH_SHORT).show();
            ...
            if(saveUri!=null){
                ...
                imageFolder.putFile(saveUri)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(HelperHome.this, "Uploaded!", Toast.LENGTH_SHORT).show();
                        imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                DatabaseReference helperInformations=FirebaseDatabase.getInstance().getReference(Common.user_helper_tbl);
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful())
                                            ...
                                            Toast.makeText(HelperHome.this, "Uploaded error!", Toast.LENGTH_SHORT).show();
        ...
        alertDialog.setPositiveButton("CHANGE PASSWORD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (edtNewPassword.getText().toString().equals(edtRepeatPassword.getText().toString())) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        FirebaseAuth.getInstance().getCurrentUser()
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            //update helper information password column
                                                            ...
                                                            helperInformation.child(Common.userID)
                                                                    ...
                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                        ...
                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                            if (task.isSuccessful())
                                                                                Toast.makeText(HelperHome.this, "Password was changed!", Toast.LENGTH_SHORT).show();
                                                                            else
                                                                                Toast.makeText(HelperHome.this, "Password was doesn't changed!", Toast.LENGTH_SHORT).show();
                                                                            waitingDialog.dismiss();
                                                            ...
                                                            Toast.makeText(HelperHome.this, "Password doesn't change", Toast.LENGTH_SHORT).show();
                                        ...
                                        waitingDialog.dismiss();
                                        Toast.makeText(HelperHome.this, "Wrong old password", Toast.LENGTH_SHORT).show();
                                    }
                    ...
                    waitingDialog.dismiss();
                    Toast.makeText(HelperHome.this, "Password doesn't match", Toast.LENGTH_SHORT).show();
                }
        ...
        if(account!=null) {
            Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(new ResultCallback<Status>() {
                ...
                public void onResult(@NonNull Status status) {
                    if (status.isSuccess()) {
                        Intent intent = new Intent(HelperHome.this, Login.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(HelperHome.this, "Could not log out", Toast.LENGTH_SHORT).show();
                    }
                }
            });
