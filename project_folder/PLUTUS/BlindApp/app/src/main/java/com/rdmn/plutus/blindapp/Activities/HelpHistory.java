...
import com.rdmn.plutus.blindapp.adapter.recyclerViewHistory.ClickListener;
import com.rdmn.plutus.blindapp.adapter.recyclerViewHistory.historyAdapter;
...
public class HelpHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blindHistory = database.getReference(Common.history_blind);
