package com.exemple.AndroidProject.blindapp.Fragments;
...
import com.exemple.AndroidProject.blindapp.Common.Common;
import com.exemple.AndroidProject.blindappp.R;
import com.exemple.AndroidProject.blindapp.Retrofit.IGoogleAPI;
...
public class BottomSheetBlindFragment extends BottomSheetDialogFragment {
    String mLocation, mDestination;
    boolean isTapOnMap;
    IGoogleAPI mService;
    TextView txtCalculate, txtLocation, txtDestination;
    public static BottomSheetBlindFragment newInstance(String location, String destination, boolean isTapOnMap){
        BottomSheetBlindFragment fragment=new BottomSheetBlindFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view0=inflater.inflate(R.layout.bottom_sheet_blind, container, false);
