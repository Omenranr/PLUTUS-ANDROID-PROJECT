package com.omenranr.plutus.helperapp.Helpers;
...
public class FirebaseHelper {
    ...
    public FirebaseHelper(AppCompatActivity activity){
        ...
        users=firebaseDatabase.getReference(Common.user_helper_tbl);
    ...
    private void goToMainActivity(){
        activity.startActivity(new Intent(activity, HelperHome.class));
        activity.finish();
    }
